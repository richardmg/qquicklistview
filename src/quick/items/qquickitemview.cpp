...
void QQuickItemView::setModel(const QVariant &m)
{
    ...
    if (d->model) {
        ...
        disconnect(d->model, SIGNAL(itemPooled(int, QObject *)), this, SLOT(itemPooledCallback(int, QObject *)));
        disconnect(d->model, SIGNAL(itemReused(int, QObject *)), this, SLOT(itemReusedCallback(int, QObject *)));
    }
    ...
    if (d->model) {
        ...
        connect(d->model, SIGNAL(itemPooled(int, QObject *)), this, SLOT(itemPooledCallback(int, QObject *)));
        connect(d->model, SIGNAL(itemReused(int, QObject *)), this, SLOT(itemReusedCallback(int, QObject *)));
        if (isComponentComplete()) {
...
void QQuickItemView::itemPooledCallback(int modelIndex, QObject *object)
{
    Q_UNUSED(modelIndex);
...
void QQuickItemView::itemReusedCallback(int modelIndex, QObject *object)
{
    Q_UNUSED(modelIndex);
