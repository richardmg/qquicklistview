...
/*!
    ...
    from the \l delegate whenever new rows are flicked into view. This approach can
    give a good performance boost, depending on the complexity of the delegate. Reusing
