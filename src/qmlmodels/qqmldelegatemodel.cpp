...
QQmlDelegateModelItem *QQmlReuseableDelegateModelItemsPool::takeItem(const QQmlComponent *delegate, int newIndexHint)
{
...
void QQmlReuseableDelegateModelItemsPool::drain(int maxPoolTime, std::function<void(QQmlDelegateModelItem *cacheItem)> releaseItem)
{
